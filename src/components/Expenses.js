        ...
        <>
            ...
            <div className="home-content">
                ...
                <div className="bot">
                    ...
                    <button className="btn-add soft-shadow" onClick={() => {addExpense(document.querySelector("#earning").value, document.querySelector("#earning-reason").value)}}>Add New Expense</button>
                </div>
            </div>
